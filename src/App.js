  ...
  {return (
    <div className="App">
      ...
      <div className="movies-section">
          <Movies isloading={this.state.isloading} text={this.state.keyword} rating={this.state.rating} addNewMovie={x => this.addNewMovie(x)} data={this.state.MoviesDescription.filter(el => el.rating >= this.state.rating && el.title.toLowerCase().includes(this.state.keyword.toLowerCase().trim() ) )} /> 
